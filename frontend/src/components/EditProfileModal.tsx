...
export default function EditProfileModal({ user, onSave, onClose }: EditProfileModalProps) {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black/50 backdrop-blur-sm z-50 p-4">
      <div className="relative bg-white/95 dark:bg-gray-900 rounded-3xl shadow-2xl w-full max-w-lg max-h-[90vh] border border-green-200 dark:border-gray-700 animate-fadeIn flex flex-col">
        {/* Header fijo */}
        ...
        {/* Título */}
          <h2 className="text-3xl font-bold text-green-700 dark:text-green-300 mb-4 text-center">
          Editar Perfil
        </h2>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-blue-700 dark:text-blue-400">
                  Modifica tu información personal, foto de perfil y datos de contacto. 
        ...
        <div className="flex flex-col items-center mb-6">
            ...
            <div 
              className="w-32 h-32 rounded-full overflow-hidden border-4 border-green-600 cursor-pointer hover:border-green-700 transition-colors shadow-md mb-4"
                  ...
                  {formData.newPassword && (
                    <div className="text-xs">
                      ...
                      <div className="text-gray-500 dark:text-gray-400">
                        ...
                        {formData.newPassword.length >= 8 && formData.newPassword.length < 12 && 'Buena'}
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <ul className="text-sm text-yellow-700 dark:text-yellow-400 space-y-1">
                  <li>• <strong>Nombre Completo:</strong> Aparece en tus publicaciones</li>
                  <li>• <strong>Correo Electrónico:</strong> Se usa para iniciar sesión</li>
                  {showPasswordSection && (
                    <>
                      <li>• <strong>Contraseña Actual:</strong> Para verificar tu identidad</li>
                      <li>• <strong>Nueva Contraseña:</strong> Mínimo 8 caracteres</li>
                      <li>• <strong>Confirmar Contraseña:</strong> Debe coincidir con la nueva</li>
                    </>
                  )}
                </ul>
              </div>
            ...
            >
              {isSubmitting ? (
                <>
                  ...
                  {showPasswordSection ? 'Cambiando contraseña...' : 'Guardando...'}
                </>
              ) : (
                'Guardar Cambios'
              )}
