...
function PostList({
  ...
  return (
    <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-md p-5 border border-blue-100 dark:border-blue-900/50">
      ...
      <div className="space-y-6 overflow-y-auto max-h-[calc(100vh-220px)] pr-2 scrollbar-thin scrollbar-thumb-rounded-full scrollbar-track-transparent scrollbar-thumb-blue-500/30 hover:scrollbar-thumb-blue-500/50">
        {posts.length > 0 ? (
          posts.map((post) => (
            <PostCard
              key={post.id}
